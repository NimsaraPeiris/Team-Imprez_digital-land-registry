  ...
  const documents = [
    {
      ...
      description: "Original land title or deed",
      format: "PDF, Original Scan",
    },
    {
      id: "id-proof",
      title: "Identity Proof",
      description: "Valid government-issued ID (NIC, Passport, etc.)",
      format: "PDF, Original Scan",
    },
    {
      id: "address-proof",
      title: "Address Proof",
      description: "Utility bill or bank statement with current address",
      format: "PDF, Original Scan",
    },
    {
      id: "application-form",
      title: "Application Form",
      description: "Completed application form for copy of land",
      format: "PDF, Original Scan",
    },
  ]
      ...
      <main className="py-8 px-[75px]">
        ...
        <div className="w-[1291px] h-[151px] bg-[#102A3D] rounded-[9px] mb-[20px] relative">
          <div className="absolute left-[23px] top-[43px] flex flex-col gap-[5px]">
            <h1 className="text-white text-[35px] font-bold leading-[42px] font-inter">Copy of Land</h1>
            ...
            <div className="mb-[65px]">
              <div className="mb-[34px]">
                ...
                <p className="text-[#747474] text-[24px] font-normal leading-[28.8px] font-inter">
                  Gather these documents before starting your application for a copy of land
                </p>
              </div>
